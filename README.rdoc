==Basic Rails api
Basic Rails api-ready to get started with API with User model and authenticating user for api access
===Gems used
Check out Gemfile
...
==== Api Key and Secret auth 
  ...
  Response:
    success: user list
    failure: HTTP Basic. Access denied.
for postman see here<code>../screens/</code>
=== References
