==Basic Rails api
Basic Rails api-ready to get started with API with User model and authenticating user for api access. Authentication of a user can be done in 3-ways explained below.
...
Its obivious to restrict the ananymous users to access the api. To restrict user access or authenticate valid user, we have three(3) methods.
